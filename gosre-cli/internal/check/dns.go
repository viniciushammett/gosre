...
func (c *DNSChecker) Execute(ctx context.Context, t domain.Target, cfg domain.CheckConfig) domain.Result {
	...
	// Honour an already-expired or cancelled context before any I/O.
	if ctx.Err() != nil {
...
// resolve dispatches to the correct net.Resolver method based on recordType.
func resolve(ctx context.Context, r *net.Resolver, host, recordType string) ([]string, error) {
	...
	default: // A (and any unrecognised type)
